...
import { EditApplicationDialog } from '@/components/forms/EditApplicationDialog'
...
export function ApplicationCard({ app, onDelete, onEdit, isDragging }: ApplicationCardProps) {
  ...
  return (
    <>
      <div
        ...
        style={style}
        className={cn(
          'bg-white rounded-lg border border-gray-200 p-3 shadow-sm group cursor-pointer',
          (isDragging || isSortableDragging) && 'opacity-50'
        )}
        onClick={() => !isSortableDragging && setEditOpen(true)}
      >
